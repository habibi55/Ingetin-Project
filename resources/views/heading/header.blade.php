<header class="w-full flex flex-wrap justify-between items-center py-4 md:py-0 md:pt-4 px-4 md:px-6 bg-white fixed">
  ...
  <nav class="hidden top-navbar justify-end items-center w-full md:flex lg:flex lg:flex-grow lg:w-auto" id="navigation">
    ...
    <div class="w-full gap-2 pt-4 md:pt-2 pb-4 md:pb-0 flex flex-col md:flex-row-reverse items-start lg:inline-flex lg:w-auto lg:items-center
      lg:h-auto ">
