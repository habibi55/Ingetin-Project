<div class="flex w-full md:w-fit flex-col ml-0 md:ml-5 items-end">
    
    <div class="relative w-full md:w-fit  text-gray-600">
        ...
        <input class="border-2 border-primer w-full md:w-72 bg-white h-10 pl-9 pr-2 rounded-lg text-sm focus:outline-none"
